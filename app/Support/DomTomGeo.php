...
class DomTomGeo
{
    ...
    private const COMMUNES = [
        'La Réunion' => [
            ...
            'lariviere' => [-21.3639, 55.4744, 'La Rivière (Saint-Louis)'],
            'riviere' => [-21.3639, 55.4744, 'La Rivière (Saint-Louis)'],
            'larivieresaintlouis' => [-21.3639, 55.4744, 'La Rivière (Saint-Louis)'],
