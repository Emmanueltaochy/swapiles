...
<section class="max-w-7xl mx-auto px-4 mt-10">
    ...
    <div class="flex gap-4 overflow-x-auto pb-2 no-scrollbar snap-x snap-mandatory">
        ...
        <a href="/recherche?category=femme"
           class="relative shrink-0 w-[280px] md:w-[340px] rounded-[28px] overflow-hidden snap-start group">
            <img src="/images/Cat-femme.PNG"
                 class="w-full h-[360px] object-cover group-hover:scale-[1.02] transition duration-300">
        </a>

        <a href="/recherche?category=enfant"
           class="relative shrink-0 w-[280px] md:w-[340px] rounded-[28px] overflow-hidden snap-start group">
            <img src="/images/Cat-enfant.PNG"
                 class="w-full h-[360px] object-cover group-hover:scale-[1.02] transition duration-300">
        </a>

        <a href="/recherche?category=homme"
           class="relative shrink-0 w-[280px] md:w-[340px] rounded-[28px] overflow-hidden snap-start group">
            <img src="/images/Cat-homme.PNG"
                 class="w-full h-[360px] object-cover group-hover:scale-[1.02] transition duration-300">
        </a>
