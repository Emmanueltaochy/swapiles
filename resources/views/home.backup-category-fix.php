...
document.addEventListener('DOMContentLoaded', function () {
    const links = {
        'Femme': '/recherche?category=femme',
        'Homme': '/recherche?category=homme',
        'Enfant': '/recherche?category=enfant',
        'Accessoires': '/recherche?category=accessoires',
        'Dons': '/recherche?type=don',
        'Échanges': '/recherche?type=echange-produits'
    };

    document.querySelectorAll('section a, section div, button').forEach((el) => {
