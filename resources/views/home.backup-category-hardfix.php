...
<section class="relative overflow-hidden bg-gradient-to-br from-teal-900 via-teal-800 to-emerald-700">
    <a href="/recherche?category=femme&submit=1" class="block"><a href="/recherche?category=homme&submit=1" class="block"><a href="/recherche?category=enfant&submit=1" class="block"><a href="/recherche?category=accessoires&submit=1" class="block"><a href="/recherche?type=don&submit=1" class="block"><a href="/recherche?type=echange-produits&submit=1" class="block"><div class="absolute inset-0 opacity-20 bg-cover bg-center" style="background-image:url('/images/hero-bg.jpg');"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3">
            ...
            <a href="/?listing_type=don" class="bg-white rounded-2xl p-4 text-center shadow-sm border hover:border-teal-300 hover:shadow-md transition">
                <div class="text-2xl mb-1">🎁</div>
                <div class="text-sm font-semibold">Dons</div></a>
            </a>
            ...
            <a href="/?listing_type=echange-produits" class="bg-white rounded-2xl p-4 text-center shadow-sm border hover:border-teal-300 hover:shadow-md transition">
                <div class="text-2xl mb-1">🔄</div>
                <div class="text-sm font-semibold">Échanges</div></a>
            </a>
...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <div class="flex items-center justify-between mb-5">
        ...
        <div class="hidden lg:flex items-center gap-2">
            <button type="button" onclick="document.getElementById('category-carousel').scrollBy({left: -520, behavior: 'smooth'})" class="w-11 h-11 rounded-full bg-white border border-gray-200 shadow-sm font-bold text-xl hover:bg-gray-50">
                ←
            </button>
            <button type="button" onclick="document.getElementById('category-carousel').scrollBy({left: 520, behavior: 'smooth'})" class="w-11 h-11 rounded-full bg-white border border-gray-200 shadow-sm font-bold text-xl hover:bg-gray-50">
                →
    ...
    <div id="category-carousel" class="flex gap-4 overflow-x-auto pb-4 snap-x snap-mandatory category-scroll">
        <a href="/recherche?category=femme"
           class="shrink-0 snap-start w-[72vw] sm:w-[45vw] lg:w-[38vw] max-w-[520px] rounded-[30px] overflow-hidden bg-gray-100 shadow-sm">
            <img src="/images/Cat-femme.PNG" class="w-full h-[420px] object-cover" alt="Femme">
        </a>

        <a href="/recherche?category=enfant"
           class="shrink-0 snap-start w-[72vw] sm:w-[45vw] lg:w-[38vw] max-w-[520px] rounded-[30px] overflow-hidden bg-gray-100 shadow-sm">
            <img src="/images/Cat-enfant.PNG" class="w-full h-[420px] object-cover" alt="Enfant">
        </a>

        <a href="/recherche?category=homme"
           class="shrink-0 snap-start w-[72vw] sm:w-[45vw] lg:w-[38vw] max-w-[520px] rounded-[30px] overflow-hidden bg-gray-100 shadow-sm">
