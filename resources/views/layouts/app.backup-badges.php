    ...
    <div class="bg-white border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-end gap-3 text-sm">
            @auth
                ...
                <a href="{{ route('account.messages.index') }}" class="font-bold text-gray-700 hover:text-teal-700">
                    Messages
                </a>

                <a href="{{ route('account.favorites.index') }}" class="font-bold text-gray-700 hover:text-teal-700">
                    Favoris
                </a>
