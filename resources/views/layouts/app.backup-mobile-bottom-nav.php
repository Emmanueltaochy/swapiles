...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelectorAll('input').forEach(function (input, index) {
        ...
        if (!placeholder.includes('rechercher') && !placeholder.includes('que cherchez-vous')) {
            return;
        }
        ...
        dropdown.className = 'hidden absolute left-0 right-0 top-full mt-2 bg-white border border-gray-100 rounded-2xl shadow-2xl z-[9999] overflow-hidden max-h-[70vh] overflow-y-auto';
